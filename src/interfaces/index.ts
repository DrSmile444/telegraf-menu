...
export interface RegularMenuConfig<Ctx extends DefaultCtx = DefaultCtx> extends
    Omit<
        GenericConfig<Ctx, string, never, RegularMenu<Ctx>>,
